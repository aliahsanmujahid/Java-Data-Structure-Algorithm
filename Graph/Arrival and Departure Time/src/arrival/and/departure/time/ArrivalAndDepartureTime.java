...
package arrival.and.departure.time;
...
private static void printGraph(Graph graph)
    ...
    public static int DFS(Graph graph, int v, boolean[] discovered,
		...
		arrival[v] = ++time;
                          System.out.println("v="+v+"arrival="+arrival[v]+"time="+time);         
		...
		departure[v] = ++time;
                         System.out.println("v=aa"+v+"departure="+departure[v] +"time="+time);
		return time;
	}
	...
	public static void main(String[] args)
	{
		...
		List<Edge> edges = Arrays.asList(
				   new Edge(0, 1), new Edge(0, 2), new Edge(2, 3),
	                                         new Edge(2, 4), new Edge(3, 5), new Edge(6, 7)
							);
